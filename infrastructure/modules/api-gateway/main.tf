...
resource "aws_api_gateway_deployment" "main" {
  ...
  # Force le redéploiement si les sources changent
  triggers = {
...
# Gateway Responses pour CORS sur les erreurs
resource "aws_api_gateway_gateway_response" "unauthorized" {
  ...
  response_parameters = {
    "gatewayresponse.header.Access-Control-Allow-Origin"  = "'https://claude-serverless.daveo-dev.fr'"
